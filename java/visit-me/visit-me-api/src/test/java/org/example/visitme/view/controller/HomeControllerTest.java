...
public class HomeControllerTest {
    ...
    public void testHealth() throws Exception {
        ...
        final ResultMatcher DATA_MATCHER = MockMvcResultMatchers.jsonPath("$.data.status", Matchers.is(RESPONSE.getStatus()));
    ...
    public void testUserRegistration() throws Exception {
        ...
        final ResultMatcher TIMESTAMP_MATCHER = MockMvcResultMatchers.jsonPath("$.timestamp", Matchers.notNullValue());
        final ResultMatcher STATUS_MATCHER = MockMvcResultMatchers.jsonPath("$.status", Matchers.is(HttpStatus.CREATED.toString()));
        ...
        mockMvc.perform(requestBuilder).andExpectAll(STATUS_CODE_MATCHER, TIMESTAMP_MATCHER, STATUS_MATCHER, MESSAGE_MATCHER, DATA_MATCHER)
            .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void testUserRegistrationWithDuplicatedCpf() throws Exception {
        ...
        final ResultMatcher MESSAGE_MATCHER = MockMvcResultMatchers.jsonPath("$.messages[0].message", Matchers.is(MESSAGE));
        MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post(SIGN_UP_ENDPOINT);
        requestBuilder.contentType(MediaType.APPLICATION_JSON);
        requestBuilder.content(new JsonMapper().writeValueAsString(signUpRequest));
        mockMvc.perform(requestBuilder).andExpectAll(STATUS_CODE_MATCHER, TIMESTAMP_MATCHER, STATUS_MATCHER, CAUSE_MATCHER, MESSAGE_MATCHER)
            .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void testSignInWithValidLogin() throws Exception {
        ...
        mockMvc.perform(requestBuilder).andExpectAll(STATUS_CODE_MATCHER, TIMESTAMP_MATCHER, STATUS_MATCHER, DATA_MATCHER)
            .andDo(MockMvcResultHandlers.print());
    }
